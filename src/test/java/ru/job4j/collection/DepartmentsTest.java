...
public class DepartmentsTest {
    ...
    public void whenManyMissedWithNaturalOrder() {
        ...
        List<String> expect = Arrays.asList("k1", "k1/sk1", "k2", "k2/sk1", "k2/sk1/ssk1", "k2/sk1/ssk1/sssk1", "k2/sk2");
        List<String> rsl = Departments.fillGaps(input);
    ...
    public void whenManyMissedWithDepDescComp() {
        List<String> input = Arrays.asList("k1/sk1", "k2", "k2/sk1", "k2/sk2", "k2/sk1/ssk1/sssk1");
        List<String> expect = Arrays.asList("k2", "k2/sk1", "k2/sk1/ssk1", "k2/sk1/ssk1/sssk1", "k2/sk2", "k1", "k1/sk1");
        List<String> rsl = Departments.fillGaps(input);
    ...
    public void whenManyMissedAndNotValid() {
        List<String> input = Arrays.asList("k1/sk1", "k2", "k1/sk2", "k2/sk1", "k2/sk2", "k2/sk1/ssk1/sssk1");
        List<String> expect = Arrays.asList("k1", "k1/sk1", "k1/sk2", "k2", "k2/sk1", "k2/sk1/ssk1", "k2/sk1/ssk1/sssk1", "k2/sk2");
        List<String> rsl = Departments.fillGaps(input);
